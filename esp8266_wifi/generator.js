...
function ensureWiFiLib(generator) {
  ...
  if (boardConfig && boardConfig.core && boardConfig.core.indexOf('esp8266') > -1) {
    // ESP8266系列开发板
...
// WiFi连接块
Arduino.forBlock['esp8266_wifi_begin'] = function(block, generator) {
...
// WiFi高级连接块
Arduino.forBlock['esp8266_wifi_begin_advanced'] = function(block, generator) {
  const ssid = generator.valueToCode(block, 'SSID', generator.ORDER_ATOMIC) || '""';
  const password = generator.valueToCode(block, 'PASSWORD', generator.ORDER_ATOMIC) || '""';
...
// WiFi断开连接块
Arduino.forBlock['esp8266_wifi_disconnect'] = function(block, generator) {
...
// WiFi状态块
Arduino.forBlock['esp8266_wifi_status'] = function(block, generator) {
  ensureWiFiLib(generator);
...
Arduino.forBlock['esp8266_wifi_status_type'] = function(block, generator) {
...
// WiFi连接状态块
Arduino.forBlock['esp8266_wifi_is_connected'] = function(block, generator) {
  ensureWiFiLib(generator);
...
// 本机IP地址块
Arduino.forBlock['esp8266_wifi_local_ip'] = function(block, generator) {
  ensureWiFiLib(generator);
...
// MAC地址块
Arduino.forBlock['esp8266_wifi_mac_address'] = function(block, generator) {
  ensureWiFiLib(generator);
...
// 信号强度块
Arduino.forBlock['esp8266_wifi_rssi'] = function(block, generator) {
  ensureWiFiLib(generator);
...
// 当前WiFi名称块
Arduino.forBlock['esp8266_wifi_ssid'] = function(block, generator) {
  ensureWiFiLib(generator);
...
// 扫描WiFi网络块
Arduino.forBlock['esp8266_wifi_scan_networks'] = function(block, generator) {
...
// 获取网络SSID块
Arduino.forBlock['esp8266_wifi_get_ssid'] = function(block, generator) {
...
// 获取网络信号强度块
Arduino.forBlock['esp8266_wifi_get_rssi'] = function(block, generator) {
  const index = generator.valueToCode(block, 'INDEX', generator.ORDER_ATOMIC) || '0';
...
// 获取网络加密类型块
Arduino.forBlock['esp8266_wifi_get_encryption_type'] = function(block, generator) {
  const index = generator.valueToCode(block, 'INDEX', generator.ORDER_ATOMIC) || '0';
...
Arduino.forBlock['esp8266_wifi_encryption_type'] = function(block, generator) {
...
Arduino.forBlock['esp8266_wifi_scan_complete'] = function(block, generator) {
  ensureWiFiLib(generator);
...
Arduino.forBlock['esp8266_wifi_scan_delete'] = function(block, generator) {
  ensureWiFiLib(generator);
...
// 创建WiFi热点块
Arduino.forBlock['esp8266_wifi_softap'] = function(block, generator) {
  const ssid = generator.valueToCode(block, 'SSID', generator.ORDER_ATOMIC) || '""';
  const password = generator.valueToCode(block, 'PASSWORD', generator.ORDER_ATOMIC) || '""';
...
// 配置热点IP块
Arduino.forBlock['esp8266_wifi_softap_config'] = function(block, generator) {
...
// 关闭WiFi热点块
Arduino.forBlock['esp8266_wifi_softap_disconnect'] = function(block, generator) {
...
// 热点连接设备数块
Arduino.forBlock['esp8266_wifi_softap_station_count'] = function(block, generator) {
  ensureWiFiLib(generator);
...
// 热点IP地址块
Arduino.forBlock['esp8266_wifi_softap_ip'] = function(block, generator) {
  ensureWiFiLib(generator);
...
// 设置WiFi模式块
Arduino.forBlock['esp8266_wifi_set_mode'] = function(block, generator) {
...
// 获取WiFi模式块
Arduino.forBlock['esp8266_wifi_get_mode'] = function(block, generator) {
  ensureWiFiLib(generator);
...
Arduino.forBlock['esp8266_wifi_mode'] = function(block, generator) {
  const mode = block.getFieldValue('MODE');
...
// 设置自动重连块
Arduino.forBlock['esp8266_wifi_set_auto_reconnect'] = function(block, generator) {
...
// 立即尝试重新连接到已保存的WiFi网络
Arduino.forBlock['esp8266_wifi_reconnect'] = function(block, generator) {
  ensureWiFiLib(generator);
  return 'WiFi.reconnect();\n';
};

// 等待连接结果块
Arduino.forBlock['esp8266_wifi_wait_for_connect_result'] = function(block, generator) {
...
Arduino.forBlock['esp8266_wifi_smartconfig_start'] = function(block, generator) {
  ensureWiFiLib(generator);
...
Arduino.forBlock['esp8266_wifi_smartconfig_stop'] = function(block, generator) {
  ensureWiFiLib(generator);
...
Arduino.forBlock['esp8266_wifi_smartconfig_done'] = function(block, generator) {
  ensureWiFiLib(generator);

...
|------------|------------|--------------------------|------------|----------------|
| `esp32_sd_mmc_begin` | Statement | MODE(dropdown) | `esp32_sd_mmc_begin(false)` | `SD_MMC.setPins(2, 1, 40, 39, 42, 41); // OJoy 4-bit ↵ if (!SD_MMC.begin("/sdcard", false)) { ↵ Serial.println("SD_MMC Mount Failed"); ↵ return; ↵ }` |

...
|------------|------------|--------------------------|------------|----------------|
| `adafruit_vl53l5cx_init` | Statement | VAR(field_input), WIRE(field_dropdown), ADDR(field_dropdown) | `adafruit_vl53l5cx_init(VAR, WIRE, ADDR)` | Dynamic code |
| `adafruit_vl53l5cx_read` | Value | VAR(field_variable), DATA(field_dropdown), INDEX(input_value) | `adafruit_vl53l5cx_read(VAR, DATA, INDEX)` | Dynamic code |
| `adafruit_vl53l5cx_action` | Statement | VAR(field_variable), ACTION(field_dropdown) | `adafruit_vl53l5cx_action(VAR, ACTION)` | Dynamic code |
| `adafruit_vl53l5cx_set` | Statement | VAR(field_variable), SETTING(field_dropdown), VALUE(input_value) | `adafruit_vl53l5cx_set(VAR, SETTING, VALUE)` | Dynamic code |
...
```
arduino_setup()
    adafruit_vl53l5cx_init("vl53l5cx")
```

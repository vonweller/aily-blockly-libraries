...
| `microbit_radio_set_power` | Statement | POWER(dropdown) | `microbit_radio_set_power(6)` | `_ailyMicrobitRadioBegin(_ailyMicrobitRadioGroup); ↵ _ailyMicrobitRadioSetPower(0);` |

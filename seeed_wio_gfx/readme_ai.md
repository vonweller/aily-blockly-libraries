...
| `seeed_gfx_draw_image` | Statement | VAR(field_variable), IMAGE(input_value), X(input_value), Y(input_value) | `seeed_gfx_draw_image(variables_get($tft), seeed_gfx_image(), math_number(0), math_number(0))` | Draw converted RGB565/RGB332 image data |

...
|------------|------------|--------------------------|------------|----------------|
| `neopixel_init` | Statement | PIN(dropdown), NUM(field_number), TYPE(dropdown) | `neopixel_init(PIN, 16, "NEO_GRB + NEO_KHZ800")` | `Adafruit_NeoPixel strip(16, PIN, NEO_GRB + NEO_KHZ800);` |
